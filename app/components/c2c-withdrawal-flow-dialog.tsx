...
export default function C2CWithdrawalFlowDialog({
  ...
  function validateForm() {
    ...
    if (!/^\d{10,15}$/.test(accountNo)) next.destinationAccountNo = "เลขบัญชีต้องมี 10–15 หลัก";
